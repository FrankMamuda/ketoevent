                ...
                if (this->visualRect(index).contains(event->pos())) {
                    ...
                    case Item::Combine:
                        if (MainWindow::instance()->isComboModeActive()) {
                            ...
                            if (id == Id::Invalid) {
                                QSqlQuery query;
                                query.exec(QString("SELECT max( %1 ) from %2").arg(Log::instance()->fieldName(Log::Combo), Log::instance()->tableName()));
                    ...
                    case Item::RemoveCombo: setComboId(Id::Invalid); break;
                    }
                }
            }
        }
