...
public:
    ...
    Var( const QString &key = QString(), const QVariant &defaultValue = QVariant(), Flags flags = NoFlags ) : m_key( key ), m_value( defaultValue ), m_defaultValue( defaultValue ), m_flags( flags ) {}
    virtual ~Var() = default;
